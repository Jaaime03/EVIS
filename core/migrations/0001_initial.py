# Generated by Django 5.2 on 2025-05-21 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estructura_tablas', models.ImageField(blank=True, null=True, upload_to='estructura_tablas/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alumno', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ejercicios_alumno', to='core.alumno')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situacion', models.CharField(choices=[('Correcto', 'Correcto'), ('Incorrecto', 'Incorrecto'), ('Anadido', 'Añadido')], max_length=50)),
