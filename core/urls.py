...
urlpatterns = [
    ...
    path('corregir-ejercicio/<int:id_enunciado_ejercicio>/paso3-ocr/', views.mostrar_paso3_validacion_ocr_view, name='vista_mostrar_paso3_ocr'),
    path('corregir-ejercicio/<int:id_enunciado_ejercicio>/paso4-final/', views.mostrar_paso4_correccion_final_view, name='vista_mostrar_paso4_final'),
